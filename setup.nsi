...
Section "Install"
  ...
  File /r "assets\fox"
  File /r "assets\ace"
  File /r "assets\calico"
  File /r "assets\esmeralda"
  File /r "assets\ghost"
  File /r "assets\gray"
  File /r "assets\jess"
  File /r "assets\kina"
  ...
  File /r "assets\blue"
  File /r "assets\gold"
  File /r "assets\purple"
  File /r "assets\orange"
  File /r "assets\pink"
  File /r "assets\maria"
  File /r "assets\silver"
  File /r "assets\silversky"
  File /r "assets\snuupy"
  File /r "assets\spirit"
  File /r "assets\valentine"
...
Section "Uninstall"
  ...
  RMDir /r "$INSTDIR\assets\fox"
  RMDir /r "$INSTDIR\assets\ace"
  RMDir /r "$INSTDIR\assets\calico"
  RMDir /r "$INSTDIR\assets\esmeralda"
  RMDir /r "$INSTDIR\assets\ghost"
  RMDir /r "$INSTDIR\assets\gray"
  RMDir /r "$INSTDIR\assets\jess"
  RMDir /r "$INSTDIR\assets\kina"
  RMDir /r "$INSTDIR\assets\lucy"
  RMDir /r "$INSTDIR\assets\maia"
  RMDir /r "$INSTDIR\assets\mike"
  RMDir /r "$INSTDIR\assets\blue"
  RMDir /r "$INSTDIR\assets\gold"
  RMDir /r "$INSTDIR\assets\purple"
  RMDir /r "$INSTDIR\assets\orange"
  RMDir /r "$INSTDIR\assets\pink"
  RMDir /r "$INSTDIR\assets\maria"
  RMDir /r "$INSTDIR\assets\silver"
  RMDir /r "$INSTDIR\assets\silversky"
  RMDir /r "$INSTDIR\assets\snuupy"
  RMDir /r "$INSTDIR\assets\spirit"
  RMDir /r "$INSTDIR\assets\valentine"
